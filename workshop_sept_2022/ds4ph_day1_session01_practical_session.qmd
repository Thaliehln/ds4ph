---
title: "Data Science for Public Health - Day 01 - Session 01"
date: "2022-09-26"
format:
  html:
    toc: true
...
::: callout-warning
**For (advanced) Python/R Markdown users only:** you still need to import the R package `reticulate` if you want to use the Knitr engine and manipulate Python objects within R code chunks.
