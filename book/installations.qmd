...
::: callout-important
RStudio does include R when you download and install it, so you need to have installed R to be able to use RStudio with R (see Section @sec-R-installation).
:::
