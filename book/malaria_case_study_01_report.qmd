...
```{r}
explanatory = c("CTX_facility_ID", "CTX_district", "CLIN_fever")
...
```{r}
facility1_df <- df %>% dplyr::filter(CTX_facility_ID == "F4153")
...
```{r}
facility1_df <- df %>% dplyr::filter(CTX_facility_ID == "F9222")
